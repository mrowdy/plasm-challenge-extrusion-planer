...
class ExtrusionPlanner:
    ...
    def __init__(
        ...
        """Initialize extrusion planner with window size and compensation strategy."""
    ...
    def process(
        ...
        Pipeline: preemptive slowdown -> pressure compensation -> hard flow limit.
        """
        if not segments:
            return []
    ...
    def __repr__(self) -> str:
        """Return string representation of planner configuration."""
        return (
